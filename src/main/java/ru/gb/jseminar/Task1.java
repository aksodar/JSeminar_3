...
public class Task1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.print(t1.sortByCollections(list));
        System.out.print(t1.sortByComparator(list));
    }
    ...
    public List<Integer> sortByComparator(List<Integer> list){
        Collections.sort(list, Comparator.reverseOrder()); // Сортирует так, какой метод мы выберем после компаратора
        return list;
    }
}
